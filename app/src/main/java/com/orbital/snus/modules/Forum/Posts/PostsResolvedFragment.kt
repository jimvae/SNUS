...
import com.orbital.snus.databinding.ModuleForumPostsResolvedBinding
import java.util.ArrayList

class PostsResolvedFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: ModuleForumPostsResolvedBinding = DataBindingUtil.inflate(
            inflater, R.layout.module_forum_posts_resolved, container, false
        )
        ...
        binding.moduleForumPostsResolved.setOnClickListener {
            findNavController().navigate(R.id.action_postsFragment_to_postsUnresolvedFragment, requireArguments())
        }
